...
<div class="historias">
	...
	<div class="col-xs-12 col-sm-6 col-md-4 vid">
		<iframe width="400" height="200" src="https://www.youtube.com/embed/pX_qWULvId4" frameborder="0" allowfullscreen></iframe>
		<h3 class="text-center tittle">Gemma Ames</h3>
...
<div class="gallery">
	...
	<div id="images">
		...
		<div class="col-xs-12 col-sm-5">
			<img class="gale" src="img/img_gallery_5.jpg" alt="">
		</div>
		<div class="col-xs-12 col-md-4">
			<img class="gale" src="img/img_gallery_1.jpg" alt="">
		</div>
		<div class="col-xs-12 col-md-4">
			<img class="gale" src="img/img_gallery_2.jpg" alt="">
		</div>
		<div class="col-xs-12 col-md-4">
