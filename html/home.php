...
<section class="jk-slider">
  ...
  <ol class="carousel-indicators" id="cant-ind">
    <li data-target="#carousel-example" data-slide-to="0" class="active"></li>
    <li data-target="#carousel-example" data-slide-to="1"></li>
    <li data-target="#carousel-example" data-slide-to="2"></li>
  </ol>

  <div class="carousel-inner" id="car-slid">
...
<!-- <div class="item active">
      <a href="#"><img src="img/slider/img3.jpg" class="slider" /></a>
        <div class="hero">
        <hgroup>
            <h1>Search for</h1>        
    ...
    <div class="item">
      <a href="#"><img src="img/slider/img2.jpg" class="slider" /></a>
       <div class="hero">
        <hgroup>
            <h1>Search for</h1>        
            <h3>the books you need and save ! </h3>
    ...
    <div class="item">
      <a href="#"><img src="img/slider/img1.jpg" class="slider"  /></a>
        <div class="hero">
        <hgroup>
            <h1>Search for</h1>        
            <h3>the books you need and save ! </h3>
      ...
      <div class="ofert col-sm-4">
        ...
        <div class="ofert col-sm-4">
            <img src="img/esp3.jpg" class="img-responsive   inter" alt="img1">
